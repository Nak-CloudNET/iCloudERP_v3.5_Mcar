        ...
        <table class="table">
            ...
            <tr class="thead" style="border-left:none;border-right: none;border-top:none;">
                <th colspan="12" style="border-left:none;border-right: none;border-top:none;border-bottom: 1px solid #9D192B !important;">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12" style="margin-bottom: -40px !important;">
                            <hr style="border-top:3px solid #9D192B !important;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-6 ">
                            <h3 style="font-size: 14px !important; color: #9D192B !important;" align="left">INVOICE# : <?= $invs->reference_no ?></h3>
                        </div>
                        <div class="col-sm-6 col-xs-6 " style="color: #9D192B !important;">
                            <h3 style="font-size: 14px !important; color: #9D192B !important;" align="right">DATE : <?= $this->erp->hrld($invs->date); ?></h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 col-xs-12" style="margin-top: -29px !important;">
...
//                    }
                    ...
                    for($j=1;$j<=$k;$j++) {
                        if($total_discount && $total_tax) {
                            echo  '<tr class="border" >
                                   <td height="34px" style="text-align: center; vertical-align: middle;border-left: 1px solid black !important;border-right: 1px solid black;border-top: 1px solid white;color:#9D192B !important;">'.$no.'</td>
                ...
                if ($invs->grand_total != $invs->total) { ?>
                    <tr class="border-foot" style="">
                        <td rowspan = "<?= $row; ?>" colspan="<?= 2; ?>" style="color:#9D192B !important;border-left: 1px solid #FFF !important; border-bottom: 1px solid #FFF !important;">
                        ...
                        <td colspan="<?= $col; ?>" style="color:#9D192B !important;text-align: right; font-weight: bold;background-color:#ffb3b3 !important;padding: 3px;">សរុប​ / <?= strtoupper(lang('total')) ?>

                        </td>
                        <td align="right" style="color:#9D192B !important;background-color:#ffb3b3 !important;padding: 3px;"><?=$this->erp->formatMoney($invs->total); ?></td>
                    </tr>
                <?php } ?>

                <?php if ($invs->order_discount != 0) : ?>
                    <tr class="border-foot">
                        <td colspan="<?= $col; ?>" style="color:#9D192B !important;text-align: right; font-weight: bold;background-color:#ffb3b3 !important;padding: 3px;">បញ្ចុះតម្លៃ / <?= strtoupper(lang('order_discount')) ?></td>
                        <td align="right" style="color:#9D192B !important;background-color:#ffb3b3 !important;padding: 3px;"><small style='color:#9D192B !important;font-size:10px;'>(<?php echo $invs->order_discount_id; ?>%)</small>&nbsp;<?php echo $this->erp->formatMoney($invs->order_discount); ?></td>
                    </tr>
                <?php endif; ?>

                <?php if ($invs->shipping != 0) : ?>
                    <tr class="border-foot">
                        <td colspan="<?= $col; ?>" style="color:#9D192B !important;text-align: right; font-weight: bold;background-color:#ffb3b3 !important;padding: 3px;">ដឹកជញ្ជូន / <?= strtoupper(lang('shipping')) ?></td>
                        <td align="right" style="color:#9D192B !important;background-color:#ffb3b3 !important;padding: 4px;"><?php echo $this->erp->formatMoney($invs->shipping); ?></td>
                    </tr>
                <?php endif; ?>

                <?php if ($invs->order_tax != 0) : ?>
                    <tr class="border-foot">
                        <td colspan="<?= $col; ?>" style="color:#9D192B !important;text-align: right; font-weight: bold;background-color:#ffb3b3 !important;">ពន្ធអាករ / <?= strtoupper(lang('order_tax')) ?></td>
                        <td align="right" style="color:#9D192B !important;background-color:#ffb3b3 !important; padding-right: 3px;"><?= $this->erp->formatMoney($invs->order_tax); ?></td>
                    </tr>
                <?php endif; ?>
                ...
                <?php if($invs->paid != 0 || $invs->deposit != 0){ ?>
                    <?php if($invs->deposit != 0) { ?>
                        <tr class="border-foot">
                            <td colspan="<?= $col; ?>" style="color:#9D192B !important;text-align: right; font-weight: bold;background-color:#ffb3b3 !important;padding-left: 3px;">បានកក់ / <?= strtoupper(lang('deposit')) ?>

                            </td>
                            <td align="right" style="color:#9D192B !important;background-color:#ffb3b3 !important;padding-right: 3px;"><?php echo $this->erp->formatMoney($invs->deposit); ?></td>
                        </tr>
                    <?php } ?>
                    <?php if($invs->paid != 0) { ?>
